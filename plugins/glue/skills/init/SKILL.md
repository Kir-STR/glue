...
Подключи правила Glue в проект. CLI неинтерактивный — UX и operator-gate держишь сам. Если в проекте уже есть правила (.claude/rules/*, CLAUDE.md) — сначала предложи /glue:adopt.
